...
from src.providers.amadeus import AmadeusProvider, RateLimitError
...
async def search_flights(
    ...
    try:
        ...
        return {
            "error": {
                "code": "RATE_LIMIT",
                "message": "Amadeus quota exceeded, retry later.",
            }
        }
    except Exception as exc:
        logger.error("Amadeus search failed (origin=%s, dest=%s): %s", origin_code, dest_code, exc)
        return {
            "error": {
                "code": "PROVIDER_ERROR",
